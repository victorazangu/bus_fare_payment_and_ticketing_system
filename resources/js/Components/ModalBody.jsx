import { XMarkIcon } from '@heroicons/react/24/outline'; // Import X icon
...
function ModalBody({ children, onClose, showCloseIcon = true }) {
    return (
        <div className="fixed left-0 top-0 z-50 flex h-full w-full items-center justify-center bg-gray-500 bg-opacity-75">
            <div className="relative w-full max-w-xl overflow-hidden rounded-lg bg-white shadow-xl dark:bg-gray-800">
